...
#crie uma variável para realizar a soma entre estes salários. crie uma função de impressão de dados para definir o cabeçalho de uma calculadora,
...
#deve ser utilizado os caracteres especiais de quebra de linha e na impressão deve apresentar apenas duas casas após a 
#vírgula imprima no final utilizando a variável de soma para imprimir o resultado final do seu exercício. 